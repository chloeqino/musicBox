    ...
    if (this.model != null){
        let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            for(let p of predictions){
                ...
                if(p.label == "closed"){
                  this.pointhistory.push(p.bbox[0]);
            ...
            if (closedhands == 1 && this.pointhistory.length == 3){
              ...
              if (this.pointhistory[0] > this.pointhistory[1] && this.pointhistory[1] > this.pointhistory[2] && this.pointhistory[0] - this.pointhistory[2] > 10 )
              {
                  this.detectedGesture = "Closed Going Right";
                  this.pointhistory = [];
              }

              if (this.pointhistory[0] < this.pointhistory[1] && this.pointhistory[1] < this.pointhistory[2] && this.pointhistory[2] - this.pointhistory[0] > 10)
              {
